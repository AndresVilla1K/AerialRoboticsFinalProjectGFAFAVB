...
: ${AMENT_CURRENT_PREFIX:="/src/docker-ros2-rover-simulation/src/install/rover_gz_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_gz_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rover_gz_description/environment/path.sh"
